...
ActiveRecord::Schema.define(version: 2022_09_23_095204) do
  ...
  create_table "purchase_informations", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    ...
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["item_purchase_id"], name: "index_purchase_informations_on_item_purchase_id"
  end
  ...
  add_foreign_key "purchase_informations", "item_purchases"
end
